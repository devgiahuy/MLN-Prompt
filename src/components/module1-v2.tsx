...
import { BrainCircuit, Database, Cpu, ChevronDown, Network, GitBranch, Zap, Sparkles, AlertTriangle, ArrowRight } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto flex flex-col items-center mt-[-10vh]">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide text-cyan-50">Module 1: Scroll-telling Infographic</span>
        </motion.div>
        ...
        >
          Triết học & AI: <br className="hidden md:block" /> Từ Lý thuyết đến Prompting
        </motion.h1>
        ...
        >
          ...
          Không cần slide, hãy cuộn xuống để trực quan hóa triết lý thành dòng chảy dữ liệu.
        </motion.p>
      </div>
      ...
      >
        <span className="text-xs uppercase tracking-widest">Cuộn để bắt đầu</span>
...
function OppositionSection() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[150vh] py-24 px-4 sm:px-8 w-full flex flex-col items-center justify-start">
      <div className="sticky top-1/4 w-full max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Sự đối lập cốt lõi</h2>
          <p className="text-slate-400 text-lg">Vật chất (Data) quyết định Ý thức (Prompt/AI Output)</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center lg:items-end">
              ...
              <p className="text-cyan-400/80 uppercase tracking-widest text-sm font-semibold mb-4">Dữ liệu & Bối cảnh</p>
              <p className="text-slate-400 max-w-sm">
                Thực tại khách quan, bối cảnh thực tế và nguồn dữ liệu đầu vào. Đây là nền tảng bắt buộc để AI có thể hiểu được bài toán.
              </p>
            </div>
          </motion.div>
             ...
             <svg width="100%" height="100%" className="absolute inset-0 z-0">
               ...
               <defs>
                 <linearGradient id="gradient-line" x1="0" y1="0" x2="1" y2="0">
                   <stop offset="0%" stopColor="#06b6d4" stopOpacity={isConnected ? "1" : "0.2"} />
                   <stop offset="100%" stopColor="#d946ef" stopOpacity={isConnected ? "1" : "0.2"} />
                 </linearGradient>
               </defs>
             </svg>
             {isConnected ? (
          ...
          >
            <div className={cn(
              ...
              isConnected ? "from-fuchsia-500/40 via-transparent to-transparent" : "from-red-500/40 via-transparent to-transparent"
            )} />
            ...
            <div className="relative z-10 flex flex-col items-center lg:items-start">
              <div className={cn(
                ...
                <BrainCircuit className={cn("w-10 h-10 transition-colors duration-700", isConnected ? "text-fuchsia-400" : "text-red-500")} />
              </div>
              <h3 className={cn("text-3xl font-bold mb-2 transition-colors duration-700", isConnected ? "text-fuchsia-50" : "text-red-50")}>
                Ý thức
              </h3>
              <p className={cn("uppercase tracking-widest text-sm font-semibold mb-4 transition-colors duration-700", isConnected ? "text-fuchsia-400/80" : "text-red-500/80")}>
                Tư duy & Mục tiêu
              </p>
              ...
              <div className="h-32 flex items-center">
                {!isConnected ? (
                  ...
                  >
                    <span className="bg-red-500/20 px-1 font-bold">WARNING:</span> Thiếu dữ liệu thực tế. <br/>
                  ...
                  >
                    Câu hỏi, mục tiêu đầu ra (Prompt). Khi được nạp đủ dữ liệu nền, Ý thức mới phản ánh đúng thực tại và định hướng AI chính xác.
                  </motion.p>
                )}
              </div>
            </div>
...
const nodes = [
  { id: "comprehensive", title: "Toàn diện", icon: Network, color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/30", glow: "rgba(96,165,250,0.5)",
    content: "Đừng chỉ cung cấp một góc nhìn cho AI. Hãy cung cấp bức tranh toàn cảnh: điểm mạnh, điểm yếu, yếu tố khách quan và chủ quan. Prompt toàn diện giúp AI không bị thiên kiến." },
  { id: "development", title: "Phát triển", icon: GitBranch, color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/30", glow: "rgba(52,211,153,0.5)",
    content: "Mọi sự vật đều vận động. Khi hỏi AI, hãy thêm yếu tố thời gian: 'Xu hướng tương lai là gì?', 'Sự việc này phát triển từ đâu?'. Điều này giúp câu trả lời có tính định hướng dài hạn." },
  { id: "historical", title: "Lịch sử - Cụ thể", icon: Zap, color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/30", glow: "rgba(251,191,36,0.5)",
    content: "Bối cảnh quyết định tất cả. Một prompt tốt phải nêu rõ: Không gian, thời gian, đối tượng cụ thể. 'Viết email cho đối tác Nhật Bản' sẽ ra kết quả hoàn toàn khác với 'Viết email cho sếp'." },
];
  ...
  return (
    <section className="relative min-h-[120vh] py-24 px-4 sm:px-8 flex flex-col items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Bản đồ tư duy Biện chứng</h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">Click vào từng nguyên lý để khám phá cách áp dụng triết lý biện chứng vào kỹ thuật Prompting AI.</p>
        </motion.div>
        ...
        <div className="relative w-full aspect-square md:aspect-[21/10] max-w-4xl mx-auto flex items-center justify-center">
          ...
          {isMounted && (
            ...
            >
              ...
              <span className="font-bold text-sm md:text-lg text-center leading-tight">Vấn đề<br/>Cốt lõi</span>
            </motion.div>
          )}
                ...
                return (
                  ...
                  >
                    <motion.button
                      ...
                      whileHover={{ scale: 1.1, boxShadow: `0px 0px 30px ${node.glow}` }}
                      whileTap={{ scale: 0.95 }}
                      className={cn(
                    ...
                    >
                      <motion.div layoutId={`node-icon-${node.id}`}>
                        <node.icon className={cn("w-8 h-8 md:w-10 md:h-10 mb-2", node.color)} />
                      </motion.div>
                      <motion.span layoutId={`node-title-${node.id}`} className="text-sm md:text-base font-bold text-white px-2 text-center leading-tight">
                        {node.title}
                      </motion.span>
                    </motion.button>
                  </div>
              ...
              {nodes.filter(n => n.id === selectedNode).map(node => (
                <motion.div
                  ...
                  className={cn(
                    ...
                    "bg-slate-900/95", node.border
                  )}
                >
                  <div className={cn("absolute inset-0 opacity-10", node.bg)} />
                  <div className="relative z-10">
                    <div className="flex items-center gap-5 mb-8">
                      <motion.div layoutId={`node-icon-${node.id}`} className={cn("p-4 rounded-2xl border", node.bg, node.border)}>
                        <node.icon className={cn("w-10 h-10", node.color)} />
                      </motion.div>
                      <motion.h3 layoutId={`node-title-${node.id}`} className="text-3xl font-bold text-white">
                        {node.title}
                      </motion.h3>
                    </div>
                    ...
                    >
                      ...
                      <button 
                        ...
                        className={cn(
                          ...
                          node.bg, node.color, node.border, "border hover:bg-opacity-20"
                        )}
                      >
                        Đã hiểu nguyên lý
                      </button>
